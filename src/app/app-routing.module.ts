...
const routes: Routes = [
  ...
  {
    path: 'article/:id',
    loadChildren: () => import('./presentation/pages/article-detail/article-detail.module').then((m) => m.ArticleDetailPageModule),
  },
  {
    path: 'article-list/:categoryId',
    loadChildren: () => import('./presentation/pages/article-list/article-list.module').then((m) => m.ArticleListPageModule),
  },
  {
    path: 'article-tabs',
    loadChildren: () => import('./presentation/pages/article-tabs/article-tabs.module').then((m) => m.ArticleTabsPageModule),
  },
  ...
  {
    path: 'membership',
    loadChildren: () => import('./presentation/pages/membership/membership.module').then((m) => m.MembershipPageModule),
  },
  { path: 'teams', loadChildren: () => import('./presentation/pages/teams/teams.module').then((m) => m.TeamsPageModule) },
  {
    path: 'team-detail/:id',
    loadChildren: () => import('./presentation/pages/team-detail/team-detail.module').then((m) => m.TeamDetailPageModule),
  },
  { path: 'birthdays', loadChildren: () => import('./presentation/pages/birthdays/birthdays.module').then((m) => m.BirthdaysPageModule) },
  {
    ...
    loadChildren: () => import('./presentation/pages/person-statistics/person-statistics.module').then((m) => m.PersonStatisticsModule),
  },
  ...
  {
    path: 'custom-backend-call',
    loadChildren: () =>
      import('./presentation/pages/custom-backend-call/custom-backend-call.module').then((m) => m.CustomBackendCallPageModule),
  },
