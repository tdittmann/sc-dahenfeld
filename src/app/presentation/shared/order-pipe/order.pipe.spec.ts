...
describe('OrderPipe', () => {
  ...
  it('should sort array by deep prop', () => {
    const arr = [{ customer: { name: 'test' } }, { customer: { name: 'b' } }, { customer: { name: 'a' } }, { customer: { name: 'c' } }];

    const res = [{ customer: { name: 'a' } }, { customer: { name: 'b' } }, { customer: { name: 'c' } }, { customer: { name: 'test' } }];
